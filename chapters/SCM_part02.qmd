...
$$
X_i \sim \operatorname{Gaussian}(\mu_{X,i}, \sigma_X^2)
$$
...
$$
M_{1,i} \sim \operatorname{Gaussian}(\mu_{M1,i}, \sigma_{M1}^2)
$$
...
$$
M_{2,i} \sim \operatorname{Gaussian}(\mu_{M2,i}, \sigma_{M2}^2)
$$
...
$$
Y_i \sim \operatorname{scaled\text{-}t}(\mu_{Y,i}, \sigma_Y, \nu)
$$
