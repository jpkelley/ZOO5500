...
_Note that many of the components in the list below should be included in a formal metadata file. For this component, it is strongly suggested you use [**YAML Metadata Template**](../templates/metadata_template.yaml), but you may also create a temporary metadata document using a spreadsheet.
