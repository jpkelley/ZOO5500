...
_These are not required readings. These are simply some useful references for you._
...
* [**Zuur et al. (2010)**](https://besjournals.onlinelibrary.wiley.com/doi/10.1111/j.2041-210X.2009.00001.x)
...
library(stringr)
library(lubridate)
library(tidyverse)   # meta-package (includes several above)
