...
\[Based primarily on the GLM Introduction lecture :contentReference[oaicite:2]{index="2"}\]
...
## Link Functions and Interpretation
...
Read in the *Lepusantilocapra pufferi* dataset and examine its structure.

```{r}
pufferi <- read.csv("data/lepusantilocapra_pufferi_abundance.csv")
