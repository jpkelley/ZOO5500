...
| **4** | **Causal Analysis Plan** | Establish causal identification. |
| **6** | **Data + Estimator Plan** | Link data to the estimand. |
| **8** | **Working Estimator Checkpoint** | Implement and diagnose the estimator. |
