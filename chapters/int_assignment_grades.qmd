...
## How the Milestone Assignments are organized (and their Purposes)

::: {.course-info tbl-colwidths="[10, 50, 40]"}
| Week | Milestone Assignment | Purpose / Goal |
|:---|:---|:---|
| **2** | **Scientific Question + Estimand Note** | Define the target effect. |
| **5** | **Data + Estimator Plan** | Link data to the estimand. |
| **8** | **Causal Analysis Plan** | Establish causal identification. |
| **9** | **Working Estimator Checkpoint** | Implement and diagnose the estimator. |
| **11** | **Estimate + Inference Checkpoint** | Make defensible inferences. |
| **12** | **Interpretation / Peer-Audit Memo** | Identify needed revisions. |
| **14** | **Integrated Analysis Draft** | Integrate the causal workflow. |
| **15** | **Final Report** | Present a defensible analysis. |
:::

## Milestone Assignment descriptions

::: {.callout-note title="**Scientific Question, Estimand Note, and first DAG (Week 2; due 11-Sep)**" icon="false" collapse="true"}
**Purpose:**\
...
-   **Broad scientific context**
    -   Briefly identify the larger proposition (major hypothesis) that your project addresses
-   **Specific hypothesis**
...
-   **Draft DAG**
    -   Create a draft Directed Acyclic Graph (following most guidelines in [DAG Construction](https://jpkelley.github.io/ZOO5500/chapters/05_02_building_dags.html)
...
::: {.callout-note title="**Causal Analysis Plan (Week 8; due 23-Oct)**" icon="false" collapse="true"}
**Purpose:**\
...
::: {.callout-note title="**Data + Estimator Plan (Week 5; due 02-Oct)**" icon="false" collapse="true"}
**Purpose:**\
...
::: {.callout-note title="**Working Estimator Checkpoint (Week 9; due 30-Oct)**" icon="false" collapse="true"}
**Purpose:**\
...
-   **Scientific question and hypothesis**
    -   Briefly establish the broader proposition and focal hypothesis(es)
...
## Submission formats: A note on Word or Quarto formats
...
::: {.course-info tbl-colwidths="[33, 30, 37]"}
