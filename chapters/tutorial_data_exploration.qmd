...
<a href="../chapters/class_r_scripts/load_packages.r" target="_blank" rel="noopener">Download the `load_packages.r` file</a>
...
\` data \|\> ggplot( aes( x = <x_variable>, y = <y_variable>, <optional_aesthetic> = <variable> ) ) + geom\_<geometry>(<geometry_options>) + labs( title = "<plot title>", x = "<x-axis label>", y = "<y-axis label>", <other_labels> ) + theme\_<theme_name>() + <optional_additional_layers>
