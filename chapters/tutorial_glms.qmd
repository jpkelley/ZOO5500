...
::::
For this first example, we will use the dataset that you were briefly introduced to in the previous section. The dataset was collected from a population of *Lepusantilocapra pufferi* (puffer jackalope) starting in the mid-1970s. As a reminder, the data include the following variables:
